...
| 相机冷启动稳定性 | 2026-08-18 延迟启动曾稳定 180 秒；2026-08-19 新周期约 67 秒后仍复现 NvCapture request 耗尽；45秒/5秒 guard 前三真机周期均有实帧、单次 START/STOP 且无新错误 | 连续模式禁用；分段 guard 已通过离线、ARM64 假接口与真机无运动验收 |
