...
- 第一次现场冷启动尝试中，系统 `16:29:29` 启动、服务 `16:29:36` active，但 eth0 已在
  `16:29:38` carrier up；ROS 节点 `16:29:51` 才出现，语音暂停在 `16:33:42`。因此只证明
  服务不等待 network-online，不能证明节点和语音在无网线条件下工作。证据不升级为通过。
